...
//        Napisati program koji uci korisnika da kaze “Molim te”. Program od korisnika ucitava zahteve koje treba
//        da izvrsi ali jedino reaguje ukoliko korisnik lepo zamoli ( u zahtevu unese “Molim te”). Ukoliko
//        korisnik unese zahtev u vidu naredjivanja, program ne reaguje na takve zahteve tj. nista ne ispisuje,
//        a ukoliko korisnik zamoli tada program ispisuje “Dogovoreno!”. Program radi dok korisnik ne unese
//        “Hvala!”. Na kraju programa ispisati “Cao”
...
//        Cao
        ...
        for (int i = 0; i < zahtev.length(); i++) {
            if (i > 0) {
                System.out.println("Unesite zahtev");
                zahtev = s.nextLine();
                if (zahtev.contains("Molim te")) {
                    System.out.println("Dogovoreno!");
                } else if (!(zahtev.contains("Molim te"))) {
                    System.out.println();
                }
